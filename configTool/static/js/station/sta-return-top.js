...
function sta_tobody() {
    var oTop = document.getElementById("sta_to_top");
    //获取可视区域宽度
    ...
    document.getElementById("tBody_sta").onscroll = function(){
        ...
        if(scrolltop>0){
            // alert("a");
            document.getElementById("sta_to_top").style.display="block";
            oTop.style.top = screenh - oTop.offsetHeight + scrolltop +"px";
            oTop.style.left = screenw - oTop.offsetWidth +"px";
        } else {
            document.getElementById("sta_to_top").style.display="none";
        }
    };
